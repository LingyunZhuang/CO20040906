...
const mutations = {
  updateIsLock(state, data) {
    state.isLock = data || false
  },
  updateSimpleNormalDiffcult(state, data) {
    state.simpleNormalDiffcult = data || []
  },
  updateThirdRoundFinished(state, data) {
    state.thirdRoundFinished = data || false
  },
  updateSecondRoundFinished(state, data) {
    state.secondRoundFinished = data || false
  },
  updateFirstRoundFinished(state, data) {
    state.firstRoundFinished = data || false
  },
  ...
  updateCurr(state, data) {
    state.curr = data || true
  },
